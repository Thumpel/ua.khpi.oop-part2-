        ...
        do
        {
            ...
            switch (command) {
                ...
                case "7":  {
                    ...
                    switch (com) {
                        case "1": {
                            Helper.sort(obj, ua.oop.khpi.Yermakov12.Helper.ESort.PASSPORT_ID);
                            break;
                        }
                        case "2": {
                            Helper.sort(obj, ua.oop.khpi.Yermakov12.Helper.ESort.PASSPORT_SERIES);
                            break;
                        }
                        case "3": {
                            Helper.sort(obj, ua.oop.khpi.Yermakov12.Helper.ESort.SALARY);
                            break;
                        }
                        case "4": {
                            Helper.sort(obj, ua.oop.khpi.Yermakov12.Helper.ESort.RATING);
                            break;
                        }
                        default:
                            System.out.println("�� ���������� ��������");
